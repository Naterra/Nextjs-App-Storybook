		...
		if (totalPages <= 0) {
			...
			return (
				<ul className="pagination">
					<li onClick={e => this.props.onClick(e, 1)} className={arrowStyleFirst}>
						<a>
					...
					{pagesArr.map((page, i) => {
						...
						return (
							<li key={i} onClick={e => this.props.onClick(e, page)} className={istyle}>
								<a>{page}</a>
							</li>
						);
					})}

					<li onClick={e => this.props.onClick(e, totalPages)} className={arrowStyleLast}>
						<a>
